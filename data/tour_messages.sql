INSERT INTO tour_messages (key, message) VALUES
 ...
 ('village', 'Here we have the Ski Village|Race down the Ski Hill or check out the EPF...|that''s Everyday Phoning Facility of course|Puffle creatures can be adopted in the Wilds...|just through the Puffle Lodge!');