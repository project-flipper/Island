...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["scope_id"], ["scopes.id"], onupdate="CASCADE", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.bulk_insert(
        ...
        [
            ...
            {"id": 1, "tag": "read", "description": "allow read access", "group_id": 0},
            {
                "id": 2,
                "tag": "write",
                "description": "allow write/mutate/modify access",
                "group_id": 0,
            },
            {
                "id": 3,
            ...
            },
            {
                "id": 4,
                "tag": "user:read",
                "description": "allow read user data",
                "group_id": 1,
            },
            {
                "id": 5,
                "tag": "user:write",
                "description": "allow write user data",
                "group_id": 2,
            },
            {
                "id": 6,
                "tag": "user:create",
                "description": "allow create user data",
                "group_id": 3,
            },
        ],
    )
